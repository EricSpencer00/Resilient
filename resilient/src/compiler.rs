...
fn node_line(n: &Node) -> Option<u32> {
    let line: u32 = match n {
        ...
        // RES-221: string interpolation — report the opening-quote line.
        Node::StringInterpolation { span, .. } => span.start.line as u32,

        // RES-222: invariant statement span.
        Node::InvariantStatement { span, .. } => span.start.line as u32,
