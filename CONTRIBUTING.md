...
hashes, Rust test-case outcomes when available, and command status.
Deterministic evidence is checksummed; timestamps and duration are stored
separately in volatile metadata.
