...
- **A-E5 increment 33 (RES-4070):** tuple provenance now composes through
  ...
  remain opaque.
- **A-E5 increment 34 (RES-4070):** tuple provenance now composes through
...
- **A-E5 increment 36 (RES-4070):** nested array provenance now composes
  through direct tuple-literal elements, so `let matrix = [[(x, 0)]]`
  exposes `matrix[0][0].0` and nested concrete tuple paths. Value elements
  and unknown shapes remain outside alias tracking.
- **A-E5 increment 37 (RES-4070):** nested array provenance now rebases
...
- **A-E5 increment 40 (RES-4070):** direct tuple literals now rebase proven
  array and struct paths from existing places used as tuple elements, so
...
- **A-E5 increment 41 (RES-4070):** direct tuple literals now retain proven
  ...
  outside alias tracking.
- **A-E5 increment 42 (RES-4070):** direct struct literals now retain proven
  paths from constant array slices used as fields, so
...
- **A-E5 increment 43 (RES-4070):** direct array literals now retain proven
  ...
  struct paths. Dynamic, transformed, unknown, and ambiguous slices remain
  outside alias tracking.
- **A-E5 increment 44 (RES-4070):** direct struct literals now retain proven
  composite paths from field-access and constant tuple-index values, so
...
- **A-E5 increment 46 (RES-4070):** known reference-return, struct-return,
  tuple-return, and array-return helpers now retain provenance when their
...
- **A-E5 increment 51 (RES-4070):** concrete tuple match patterns now rebase
  known reference leaves onto their arm-local bindings, including nested tuple
  paths. OR, literal, wildcard, dynamic, transformed, unknown, and ambiguous
  patterns remain outside alias tracking.
- **A-E5 increment 52 (RES-4070):** concrete `Some`, `Ok`, and `Err` match
...
- **A-E5 increment 64 (RES-4070):** direct `Some`, `Ok`, and `Err`
...
- **A-E5 increment 66 (RES-4070):** tagged-enum constructor identity and
...
- **A-E5 increment 67 (RES-4070):** Option and Result constructor identity and
  ...
  direct helpers. Mixed constructors, wrapped returns, recursive or ambiguous
  helpers, and unknown arguments remain opaque.
- **A-E5 increment 68 (RES-4070):** straight-line whole-value local aliases
...
- **A-E5 increment 69 (RES-4070):** straight-line whole-value local aliases
  ...
  unambiguous reference payload paths at callers. Reassigned, branched,
  wrapped, recursive, ambiguous, and unknown values remain opaque.
- **A-E5 increment 70 (RES-4070):** straight-line whole-value local aliases
...
- **A-E5 increment 71 (RES-4070):** straight-line whole-value local aliases
  ...
  paths at callers. Reassigned, branched, wrapped, recursive, ambiguous,
  value-only, and unknown values remain opaque.
- **A-E5 increment 72 (RES-4070):** straight-line whole-value local aliases
  inside direct array-return helpers now preserve unambiguous reference element
  and nested paths at callers. Reassigned, branched, wrapped, recursive,
  ambiguous, value-only, and unknown values remain opaque.
- **A-E5 increment 73 (RES-4070):** constant-bound slices inside direct
...
- **A-E5 increment 76 (RES-4070):** constant-bound slices used as direct
  tuple-return elements now preserve their rebased array-element and nested
  reference paths. Dynamic bounds, transformed sources, mixed returns, and
  ambiguous shapes remain opaque.
